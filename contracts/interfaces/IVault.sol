...
interface IVault {
    ...
    function CORE_OWNER() external view returns (address);
    ...
    function epochEmissions(uint256) external view returns (uint128);
    ...
    function totalUpdateEpoch() external view returns (uint64);
